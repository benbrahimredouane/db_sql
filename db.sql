...
CREATE TABLE advisors (
  PRIMARY KEY advisor_id int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE customers (
  PRIMARY KEY customer_id int NOT NULL AUTO_INCREMENT,
  full_name varchar(250) DEFAULT NULL,
  email varchar(250) DEFAULT NULL,
...
CREATE TABLE transactions (
  PRIMARY KEY transaction_id int NOT NULL AUTO_INCREMENT,
